    ...
    <html lang="en">
      ...
      >
         <nav className='flex justify-between p-4  lg:justify-around   lg:p-6  shadow-sm items-center  absolute top-8 left-2 right-2 w-[90%]   m-auto '>
                    <Image alt='frame-black' src={frameBlack}  className='z-10 absolute  w-full h-16 lg:h-32'/>
                        ...
                        <span className='lg:flex items-center justify-between gap-7 hidden z-20'>
                            <ul className='justify-between gap-5  flex'>
                                <li className='text-[#CDCDCD] font-normal text-lg uppercase hover:cursor-pointer'>Home</li>
                                <li className='text-[#CDCDCD] font-normal text-lg uppercase hover:cursor-pointer'>Why Wertex</li>
                                <li className='text-[#CDCDCD] font-normal text-lg uppercase hover:cursor-pointer'> About us</li>
                                <li className='text-[#CDCDCD] font-normal text-lg uppercase hover:cursor-pointer'>Industry</li>
                                <li className='text-[#CDCDCD] font-normal text-lg uppercase hover:cursor-pointer'>Services</li>
                                <li className='text-[#CDCDCD] font-normal text-lg uppercase hover:cursor-pointer'>CaseStudy</li>
                            </ul>
