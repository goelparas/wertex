...
const Inovation = () => {
    return (
        <Section  className='bg-transparent'>
            ...
            <Section className='grid grid-cols-3 bg-transparent  m-auto content-center gap-x-6 gap-y-3 lg:gap-y-11 lg:gap-x-5 lg:w-[84rem]'>
                {
                    Innovation.map((item, index) =>
                        <div className='aspect-[4/7]  w-[7.5rem] h-52    lg:w-full lg:h-[700px]   relative mx-auto' key={item.title}>
