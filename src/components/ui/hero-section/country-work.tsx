        ...
        <div className=' h-screen relative '>
            ...
            <div className='h-3/4 lg:h-4/5 relative w-full  bg-custom-map-gradient'>
                ...
                <div className='flex flex-col lg:flex-row  gap-2  lg:gap-2 p-2 m-5 lg:p-6 lg:absolute lg:bottom-4 justify-between  rounded-md  w-[90%]  lg:mx-auto left-0 right-0 relative'>
                    ...
                    <a className="z-10 bg-white font-bold text-xxs ml-6 text-black text-left  lg:hidden  md:text-[1rem] p-2  max-w-max  clipped uppercase" href="mailto:contact@wertex.in?subject=Query%20Regarding%20Manufacturing&body=Hello,%0A%0AI%20have%20some%20queries%20regarding%20your%20manufacturing%20process.%0A%0AThank%20you.">Contact us</a>
                </div>
